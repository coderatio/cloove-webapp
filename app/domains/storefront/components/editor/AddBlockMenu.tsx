...
import { PlusSignIcon as Plus, Cancel01Icon as X } from "@hugeicons/core-free-icons"
      ...
      <div className="flex items-center gap-4 w-full max-w-lg">
        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            ...
            >
              <HugeiconsIcon icon={Plus} className="w-5 h-5 transition-transform duration-300 data-[state=open]:hidden" />
              <HugeiconsIcon icon={X} className="w-5 h-5 transition-transform duration-300 hidden data-[state=open]:block" />
            </Button>
          </PopoverTrigger>
                  ...
                  return (
                    ...
                    >
                      <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 bg-brand-deep/5 dark:bg-white/5 group-hover:bg-brand-green/10 dark:group-hover:bg-brand-gold/10 transition-colors duration-200">
                        <HugeiconsIcon icon={Icon} className="w-4 h-4 text-brand-deep/60 dark:text-white/60 group-hover:text-brand-green dark:group-hover:text-brand-gold transition-colors duration-200" />
                      </div>
    ...
    <div className="relative flex items-center justify-center h-12 my-6 group">
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          ...
          >
            <HugeiconsIcon icon={Plus} className="w-5 h-5 transition-transform duration-300 group-data-[state=open]:hidden" />
            <HugeiconsIcon icon={X} className="w-5 h-5 transition-transform duration-300 hidden group-data-[state=open]:block" />
          </Button>
        </PopoverTrigger>
