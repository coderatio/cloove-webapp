...
export const initialTransactions: FinanceTransactionMock[] = [
    ...
    { id: 'TX-9026', reference: 'TX-9026', type: 'Debit', amount: '₦50,000', amountNumeric: 50000, customer: 'Rent: Feb 2026', status: 'Cleared', date: 'Feb 1', method: 'Bank Transfer', storeId: 'store-1' },
