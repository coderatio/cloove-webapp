                ...
                <li key={item.href + item.label}>
                    ...
                    >
                        <span className="flex min-w-0 items-center gap-2">
                            <HugeiconsIcon icon={item.icon} className="h-4 w-4 shrink-0 text-brand-gold opacity-80" />
                            <span className="truncate">{item.label}</span>
                        </span>
                        <HugeiconsIcon icon={ArrowUpRight} className="h-3.5 w-3.5 shrink-0 opacity-40 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                    </Link>
                </li>
            ))}
        </ul>
