    ...
    ({ className, hoverEffect = false, allowOverflow = false, ...props }, ref) => {
        return (
            <div
                ref={ref}
                className={cn(
                    "relative rounded-[32px] border border-brand-green/10 bg-brand-cream/40 backdrop-blur-xl shadow-[0_8px_32px_rgba(6,44,33,0.04)] transition-all duration-300 will-change-transform",
                    ...
                    "dark:bg-white/3 dark:border-white/10 dark:shadow-[0_8px_24px_rgba(0,0,0,0.2)] dark:before:from-white/5 dark:backdrop-blur-2xl",
