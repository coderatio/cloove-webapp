                ...
                >
                    <GlassCard className="p-4 md:p-5 border-brand-green/10 bg-brand-cream/80 dark:bg-brand-deep/80 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-4 relative z-10">
                            <div className="flex h-12 w-12 rounded-2xl bg-brand-deep dark:bg-brand-gold/10 items-center justify-center flex-shrink-0 shadow-lg overflow-hidden border border-brand-gold/20">
                                <Image
